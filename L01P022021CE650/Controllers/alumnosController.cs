...
using L01P022021CE650.Models;

namespace L01P022021CE650.Controllers
{
    public class alumnosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,codigo,nombre,apellidos,dui")] alumnos alumnos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,codigo,nombre,apellidos,dui")] alumnos alumnos)
        {
            if (id != alumnos.id)
            {
                return NotFound();
